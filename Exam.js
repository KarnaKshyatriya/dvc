...
const questionsData = [
  ...
  },
  {
    ...
    options: [
      ...
      "The directory is moved but the files are not moved",
      "Both A & B",
    ],
    correctOption: 3,
  },
  ...
  },
  {
    ...
    options: [
      "From Format cells dialog box choose shrink to fit",
      "From Format cells dialog box select the Central alignment",
      "From Format cells dialog box choose Merge cells",
      "From alignment group choose Merge & center and click",
    ],
    correctOption: 3,
  },
  {
    ...
    options: [
      ...
      "The study of how to create machines capable of performing tasks that require human intelligence",
